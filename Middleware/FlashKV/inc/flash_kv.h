...
#define FLASH_KV_RECORD_MAGIC       0xA55AU
#define FLASH_KV_RECORD_HEADER_SIZE 10U
#define FLASH_KV_RECORD_COMMIT_OFFSET 9U
#define FLASH_KV_RECORD_COMMIT_MARKER 0x5AU
