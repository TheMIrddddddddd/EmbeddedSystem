...
#define HEALTH_WATCHDOG_RELOAD          781U
...
typedef uint32_t (*health_heartbeat_getter_t)(void);

typedef struct
{
    health_heartbeat_getter_t getter;
...
{
    { protocol_task_get_heartbeat, 0U, 0U, 0U, 1U },
    { sample_task_get_heartbeat,   0U, 0U, 0U, 1U },
    { alarm_task_get_heartbeat,    0U, 0U, 0U, 1U },
    { control_task_get_heartbeat,  0U, 0U, 0U, 1U },
    { display_task_get_heartbeat,  0U, 0U, 0U, 1U }
};
